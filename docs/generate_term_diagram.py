"""
TERM Architecture Diagram — Accurate Final Version
===================================================
Every component reflects the actual term_model.py code exactly.
...
ax.text(FW/2, FH - 0.28,
        "TERM  —  Vision · Experience · Reasoning · Action",
...
leg_items = [
    ...
    (C_EXP,  "Experience / E_exp (type=4)  ← E in TERM"),
    (C_HIS,  "Action History (type=3)"),
    (C_FUSE, "LLaMA Reasoning Transformer  ← R in TERM"),
...
ax.text(cx0, cy0 + 0.44, "TERM Acronym Map",
