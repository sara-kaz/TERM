"""
TERM Architecture Diagram — clean v2
"""
import matplotlib
matplotlib.use("Agg")
...
txt(ax, LX+1.2, LY0 - 0.55 - len(items)*0.48 - 0.4,
    "TERM Acronym", fs=MD, col="#222222", bold=True)
acr = [
    ("V", "Vision  (Stream 1)",                      C_VIS),
    ("E", "Experience  (Stream 3b — the E in TERM)", C_EXP),
...
# ── Save ──────────────────────────────────────────────────────────────────────
out = "/Users/HP/Desktop/University/VLA-Robot-Learning/docs/TERM.png"
