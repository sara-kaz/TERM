%% ============================================================================
%%  TERM: Vision-Experience-Reasoning-Action — NeurIPS 2026 Submission
%%  Authors: Sara Aly
%% ============================================================================
...
\newcommand{\modelname}{\textsc{TERM}\xspace}
...
\newcommand{\termresult}[2]{$#1\,{\pm}\,#2$}  %% e.g. \termresult{51.4}{1.9}

%% ============================================================================
\title{\textbf{TERM}: Closed-Loop Feedback for\\
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{docs/TERM.png}
...
\fbox{\parbox{0.90\linewidth}{\centering\vspace{1.5em}
  ...
  \textit{Data source:} \texttt{checkpoints/\{full\_term,bc\_baseline\}/seed*/sft\_term\_log.json}
...
Table~\ref{tab:flops} breaks down TERM's per-step inference cost.
...
\begin{table}[h]
\centering
\caption{TERM per-step inference FLOPs breakdown ($T{=}3$ frames, $H{=}4$ history, $S{=}11$ tokens).}
\label{tab:flops}
\small
\begin{tabular}{lrr}
\toprule
...
Table~\ref{tab:ablations} reports one completed column (Language-Table: Full TERM and BC)
