#!/usr/bin/env bash
# Run 1000-chain CALVIN eval when calvin_sim_term best checkpoint exists.
set -euo pipefail
ROOT="$(cd "$(dirname "$0")/.." && pwd)"
CKPT="$ROOT/checkpoints/calvin_sim_term/seed123/best_sft_term.pt"
LOGDIR="$ROOT/checkpoints/calvin_sim_term/seed123/calvin_rollout_eval_1000"
